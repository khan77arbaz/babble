    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const draw = ()=>{
            ...
            for(let x = 0; x <= width; x += 10){
                const defaultWaveHeight = 20; // Doubled the default height
                const waveHeight = defaultWaveHeight + (isVoiceDetected ? voiceIntensity * 80 : 0); // Doubled the voice-activated height
            ...
            ctx.fill();
            // Animate the wave continuously, regardless of voice detection
            waveOffset -= 2;
            // Draw the audio waveform if recording
            if (isRecording && audioData?.length) {
                ...
                for(let i = 0; i < audioData.length; i++){
                    const v = audioData[i] / 128.0; // Normalize to [-1, 1]
                    const amplification = isVoiceDetected ? 1 + voiceIntensity * 5 : 1; // Increase amplification when voice is detected
        ...
        draw();
        return ()=>{
            ctx.clearRect(0, 0, width, height); // Clear canvas on unmount
        };
    }, [
        isRecording,
        audioData,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WaveformVisualizer, {
...
_s1(Home, "b8VlL5HSvNoepYmGgUkGTvRuzbg=");
_c1 = Home;
var _c, _c1;
